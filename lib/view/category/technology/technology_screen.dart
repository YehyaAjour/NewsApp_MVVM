              ...
              children: [
                Container(
                  ...
                  child: ConditionalBuilder(
                    condition: cubit.technologyList[index]['urlToImage'] != null,
                    builder: (context) {
                      return Image(
                          fit: BoxFit.cover,
                          image: CachedNetworkImageProvider(
                              '${cubit.technologyList[index]['urlToImage']}'));
                    },
                    fallback: (context) {
                      return Shimmer(
                        child: Container(
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      CustomText(
                        '${cubit.technologyList[index]['title']}',
                        color: Colors.black,
                        fontFamily: 'din',
                        fontSize: 15,
                        maxLines: 2,
                      ...
                      Row(
                        children: [
                          CustomText(
                            '${cubit.technologyList[index]['publishedAt']}',
                            color: Colors.black,
                            fontFamily: 'din',
                            fontSize: 13,
                          ),
