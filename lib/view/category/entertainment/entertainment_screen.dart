              ...
              children: [
                Container(
                  ...
                  child: ConditionalBuilder(
                    condition: cubit.entertainmentList[index]['urlToImage'] != null,
                    builder: (context) {
                      return Image(
                          fit: BoxFit.cover,
                          image: CachedNetworkImageProvider(
                              '${cubit.entertainmentList[index]['urlToImage']}'));
                    },
                    fallback: (context) {
                      return Shimmer(
                        child: Container(
                ...
                Flexible(
                  child: Column(
                    ...
                    children: [
                      CustomText(
                        '${cubit.entertainmentList[index]['title']}',
                        color: Colors.black,
                        fontFamily: 'din',
                        fontSize: 15,
                        maxLines: 2,
                      ...
                      Row(
                        children: [
                          CustomText(
                            '${cubit.entertainmentList[index]['publishedAt']}',
                            color: Colors.black,
                            fontFamily: 'din',
                            fontSize: 13,
                          ),
